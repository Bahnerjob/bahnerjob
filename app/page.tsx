<article className="panel">
            ...
            <div style={{display:"flex", gap:"12px", flexWrap:"wrap", alignItems:"center", marginTop:"20px"}}>
              ...
              <Link href="/pricing" className="btn btn-secondary" aria-label="Pakete und Leistungen">Pakete & Leistungen</Link>Pakete ansehen</Link>
            </div>
          </article>
      ...
      <section>
        <div className="container" style={{display:"flex", alignItems:"center", justifyContent:"space-between"}}>
          ...
          <Link href="/pricing" className="btn btn-secondary">Pakete & Leistungen</Link>Pakete ansehen</Link>
        </div>
