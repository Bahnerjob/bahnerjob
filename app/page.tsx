...
export default async function HomePage() {
  ...
  return (
    <div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-[200px_1fr] gap-6 md:gap-8 items-start">
            ...
            <div>
              ...
              {/* Buttons zentriert */}
              <div className="mt-6 flex flex-wrap gap-3 justify-center md:justify-center">
      ...
      {/* FÜR WEN?  klare Copy für Unternehmen / Fachkräfte */}
