...
export const metadata = {
  ...
  description: "Spezialisierte JobbÃ¶rse fÃ¼r den Bahnsektor. Klare Pakete fÃ¼r Unternehmen, schnelle Suche fÃ¼r Bewerber:innen.",
};
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-12">
      <section className="text-center">
        <div className="inline-flex items-center gap-2 rounded-full border border-neutral-800 bg-neutral-900/40 px-3 py-1 text-xs text-neutral-300">Die JobbÃ¶rse fÃ¼r den Bahnsektor</div>
        <h1 className="mt-5 text-3xl sm:text-4xl font-semibold tracking-tight">Klar. Fokussiert. Bahnerjob.</h1>
        <p className="mx-auto mt-4 max-w-2xl text-neutral-300">Stellen finden und Talente erreichen  ohne Ablenkung. Ruhiges Design, klare Informationen, deutliche Bereiche und moderne Darstellung.</p>
      ...
      <section className="mt-10 grid gap-6 md:grid-cols-2">
        <article className="rounded-2xl border border-neutral-800 bg-neutral-950 p-6">
          ...
          <p className="mt-3 text-neutral-300">Erreiche qualifizierte Bahn-Profile. Anzeige in Minuten erstellen, Vorschau prÃ¼fen und sicher verÃ¶ffentlichen. Optional: <em>Featured</em> & <em>Boost</em>.</p>
        ...
        <article className="rounded-2xl border border-neutral-800 bg-neutral-950 p-6">
          ...
          <p className="mt-3 text-neutral-300">Suche gezielt nach Ort oder Arbeitgeber. Klare Anzeigen mit den wichtigen Details, damit du schnell entscheiden kannst.</p>
          <ul className="mt-4 space-y-2 text-neutral-300">
            <li> Filter fÃ¼r Ort, Bundesland & Vertragsart (wenn vorhanden)</li>
            <li> Ãœbersichtliche Infos: Aufgaben, Anforderungen, Benefits</li>
      ...
      <section className="mt-10">
        ...
        <p className="mt-3 max-w-3xl text-neutral-300">Wir achten auf klare Angaben (Position, Aufgaben, Anforderungen, Benefits) und einheitliche Formate  so finden Kandidat:innen schneller, was wichtig ist, und Unternehmen sparen Zeit bei der Vorauswahl.</p>
      </section>
      ...
      <section className="mt-10 rounded-2xl border border-neutral-800 bg-neutral-950 p-8 text-center">
        ...
        <p className="mt-2 text-neutral-300">Finde jetzt passende Stellen oder starte mit deiner ersten Anzeige.</p>
