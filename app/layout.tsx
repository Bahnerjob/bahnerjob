  ...
  return (
    <html lang="de">
      ...
      <body style={{ minHeight: "100vh", position: "relative" }}>
        {/* Fester vollflächiger dunkler Backdrop hinter allem Inhalt */}
        <div
          id="__bj_dark_backdrop"
          style={{
            position: "fixed",
            inset: 0,
            background: "#0a0a0b",
        ...
        <header className="site-header">
          <div className="container" style={{height:"64px", display:"flex", alignItems:"center", justifyContent:"space-between"}}>
            ...
            {/* Header-CTAs optional  Startseite hat die Haupt-CTAs */}
          </div>
        </header>
